...
$data = array( "filedata" => $cFile, "filename" => $cFile->postname);
   ...
   //print_r($obj2);
    //print_r($obj2);
    $mediaId= $obj2->{"response_object"}->{"media_id"};
    curl_close($ch2);
...
// Set url
curl_setopt($ch, CURLOPT_URL, 'http://cleverflowcoreapi.azurewebsites.net/api/advertisers/update_brand');
