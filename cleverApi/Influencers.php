...
function validateMail($mail){
    ...
    // Set url
    curl_setopt($ch, CURLOPT_URL, 'http://cleverflowcoreapi.azurewebsites.net/api/influencers/check_mail_availability?mail_address='.$mail);
    ...
    function validateCredentials($mail,$pass){       
        $sign = new Sign();
        $params = array('mail_address' => $mail, 'password' => $pass);
        ...
        // Set url
        curl_setopt($ch, CURLOPT_URL, 'http://cleverflowcoreapi.azurewebsites.net/api/administrators/validate_credentials'.$paramsUrl);
    ...
    function getAccountSummary($uuid){
        ...
        // Set url
        curl_setopt($ch, CURLOPT_URL, 'http://cleverflowcoreapi.azurewebsites.net/api/influencers/get_account_summary?uuid='.$uuid);
