    ...
    <body class="login-bg">
        ...
        <?
			   ...
			   ?>
				...
				<form action="php/updateAccountFB.php" id="formRedes" method="POST">
				...
				<input type="hidden" name="facebook_id" value="<? echo $_GET['red'];  ?>" />
                <div class="row">
        ...
        <script>
			...
			jQuery.ajax({
				url: "php/getDataAccountFB.php?id=<? echo $_GET['red'];  ?>"
			})
			.done(function(data, textStatus, jqXHR) {
				res= JSON.parse(data);
				console.log(res);
